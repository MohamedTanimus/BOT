...
def start(message):
	...
	url = f"https://api.telegram.org/bot{tok}/getchatmember?chat_id=@Freeintrn&user_id={idd}"
	req = requests.get(url)
	if idd == "5384214726" or 'member' in req.text or 'creator' in req.text or 'administartor' in req.text:
